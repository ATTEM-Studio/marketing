create unique index check_ins_action_plan_user_unique_idx
  on public.check_ins (action_plan_id, user_id);
...
revoke all on function public.complete_action_plan(uuid, numeric, numeric, text) from public, anon;
grant execute on function public.complete_action_plan(uuid, numeric, numeric, text) to authenticated;
